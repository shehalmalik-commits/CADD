...
const REVIEWS = [
  {
    ...
    quote:
      'I am Sidhan. I had a great learning experience at CADD Centre Perinthalmanna while pursuing the Interior Designing course. The classes were well-structured, covering tools like AutoCAD, 3ds Max, SketchUp, Lumion and other essential design software, which are very useful for real-world projects.'
  },
  {
    id: 'ajaykrishna',
    name: 'Ajaykrishna PT',
    ...
    quote:
      'I completed my Revit MEP course at CADD Centre Perinthalmanna, one of the best for BIM, MEP, AutoCAD, Mechanical SolidWorks. The classes were well-structured and very easy to understand, even for beginners. The trainers are highly supportive and knowledgeable.'
  },
  {
    id: 'darshana',
    name: 'darshana K',
    ...
    quote:
      'The interior designing course at CADD Centre Perinthalmanna is a good and best option for who want to build practical design skills. The course covers both theory and software training, including tools like AutoCAD, SketchUp, 3ds Max, and V-Ray, which are essential in the interior...'
  },
  {
    id: 'afna',
    name: 'Afna Vahid',
    ...
    quote:
      'I had a wonderful experience at CADD earning AutoCAD, Revit, and 3ds Max teaching was clear and practical, which understand the software easily. The d trainers are very supportive and friendly.'
  },
  {
    id: 'amjad',
    name: 'Amjad Yousuf',
    ...
    quote:
      'I got an excellent training experience at CADD Centre. The faculties were friendly and supportive and good lab facilities. Industry oriented teaching. It is the leading and best centre in Perinthalmanna.'
  },
  {
    id: 'sharuz',
    name: 'sharuz vlog',
    ...
    quote:
      'I am Sarath from Koppam. I had a great learning experience at CADD Centre doing BIM for Architecture. The trainers explain complex concepts in a very simple and practical way, making it easy to understand with hands-on live project training.'
  },
  {
    id: 'haritha',
    ...
    quote:
      'I recently completed Revit Architecture training at CADD Centre and it was a great learning experience. The classes were practical, well-structured, and focused on real-time project work with Autodesk certified trainers.'
  },
  {
    id: 'shibil',
    name: 'Shibil Shibil',
    ...
    quote:
      'I am Shibil. I joined here for interior design course. Wonderful atmosphere for studies. The faculties were industry experts with a handful of practical experience. CADD Centre helped me improve my skills significantly.'
  }
];
          ...
          {REVIEWS.map((review, idx) => {
            ...
            return (
              <div
                ...
                className={`absolute top-0 w-[300px] sm:w-[350px] md:w-[380px] h-[440px] sm:h-[460px] bg-white rounded-[26px] p-6 sm:p-7 flex flex-col items-center justify-between text-center transition-all duration-500 ease-out cursor-pointer ${
                  isCenter
