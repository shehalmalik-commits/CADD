...
export default function WorkshopModal({ isOpen, onClose, initialWorkshop = '' }) {
  ...
  const [formData, setFormData] = useState({
    ...
    location: '',
    workshop: initialWorkshop || 'IntelliBuild - Smart Building Design',
  ...
  const whatsappUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
    `Hi CADD Centre Manjeri! I'd like to register for the workshop: ${formData.workshop} (${formData.mode}). Name: ${formData.name}, Location: ${formData.location || 'Manjeri'}.`
  )}`;
          ...
          {!submitted ? (
                ...
                <div>
                  ...
                  <div className="mb-4 sm:mb-5 text-left pr-8">
                    ...
                    <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                      Enter your details below to register for the official certified workshop series.
                    </p>
                  </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            className="w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-[#0E1624] border border-white/10 text-xs font-medium text-white focus:outline-none focus:border-[#C4161C] focus:ring-1 focus:ring-[#C4161C] transition-all cursor-pointer"
                          >
                            <option value="IntelliBuild - Smart Building Design" className="bg-[#0E1624] text-white">IntelliBuild - Smart Building Design</option>
                            <option value="SmartPro - Smart Product Design" className="bg-[#0E1624] text-white">SmartPro - Smart Product Design</option>
                            <option value="Scientific Vastu Masterclass" className="bg-[#0E1624] text-white">Scientific Vastu Masterclass</option>
                          </select>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-2">
                      ...
                      >
                        <span className="relative z-10 font-bold tracking-wide">
                          Submit Workshop Registration <span className="font-sans">→</span>
                        </span>
            ...
            <div className="w-full p-8 sm:p-12 text-center space-y-4 max-w-xl mx-auto">
              ...
              <div className="p-4 rounded-2xl bg-white/[0.04] border border-white/10 text-left space-y-1.5 max-w-md mx-auto">
                ...
                <p className="text-xs text-slate-300">
                  <span className="text-slate-400">Course:</span> <strong className="text-blue-400">{formData.discipline}</strong> ({formData.mode})
                </p>
                <p className="text-xs text-slate-300">
